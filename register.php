    ...
    if (isset($_POST['submit'])) {
        ...
        if ($cek_login > 0) {
            ...
            if ($password != $password2) {
                ...
                mysqli_query($conn, "INSERT INTO user (nama, username, password) VALUES ('$nama', '$username', '$hashed_password')");
                echo "<script>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input type="text" class="form-control" id="user" name="user" placeholder="Nama Lengkap" required>
                                </div>
                            </div>
                        </div>
